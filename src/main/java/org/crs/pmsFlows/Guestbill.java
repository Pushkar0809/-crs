...
public class Guestbill {
    public static void guestbill(ChromeDriver driver) throws InterruptedException {
        driver.findElement(By.xpath("//img[@alt='More Actions']")).click();
        Thread.sleep(3000);
        //CLICK TO GENERATE GUEST BILL
        driver.findElement(By.xpath("//button[contains(@class, 'btn-secondary-outline') and text()=' Generate Guest Bill ']")).click();
        Thread.sleep(3000);
        driver.findElement(By.xpath("//button[contains(@class, 'btn-danger') and contains(@class, 'ng-star-inserted')]")).click();
...
//        Thread.sleep(5000);
        ...
        //MOVE TO THE RESERVATION FROM ADD-ON BILL
        driver.findElement(By.xpath("//button[text()=' Master Bill ']")).click();
        Thread.sleep(3000);
